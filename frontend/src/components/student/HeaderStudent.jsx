...
const HeaderStudent = ({ user, sidebarOpen, setSidebarOpen, onLogout }) => {
  return (
      ...
      <div className="flex items-center justify-between px-8 py-5">
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium">Espace Étudiant</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-5">
          <div className="px-5 py-2.5 rounded-xl bg-gray-50 border border-gray-200">
            <p className="text-sm font-semibold text-gray-800">Étudiant</p>
            <p className="text-xs text-gray-500 font-medium">{user?.full_name || 'Étudiant'}</p>
          </div>
          <button
            onClick={onLogout}
